...
export const selectBudgetById = (id: number) => (state: RootState) => state.data.budgets.byId[id];

export const selectBudgetByName = (name: string) => (state: RootState) => state.data.budgets.byName[lowerCase(name)];
...
export const selectBudgetsLastFetched = (state: RootState) => state.data.budgets.lastFetch;
